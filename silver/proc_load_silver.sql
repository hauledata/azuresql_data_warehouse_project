...
BEGIN
    ...
    SET @start_time = GETDATE();
        ...
        SELECT
            ...
            CASE WHEN UPPER(TRIM(cst_marital_status)) = 'S' THEN 'Single'
                ...
                ELSE 'n/a'
            END cst_marital_status, -- Normalize marital stutus values to readable format
    ...
    SET @start_time = GETDATE();
        ...
        SELECT 
            ...
            END AS sls_order_dt,  --Check the valid date
    ...
    SET @start_time = GETDATE();
        ...
        SELECT 
            ...
            CASE WHEN bdate > GETDATE() THEN NULL
                ELSE bdate
            END AS bdate, --Set the valid birthdates
    ...
    SET @start_time =  GETDATE();
        ...
        SELECT 
            ...
            CASE WHEN TRIM(cntry) = 'DE' THEN 'Germany'
                ...
                ELSE TRIM(cntry)
            END AS cntry  --Normalize and Handle missing country value
